/* Publishing data to MQTT broker from two temperature sensors: DHT22 and DS18B20
 ...
 Code also publishes temperature from DS18B20 temperature sensor to another topic

 The circuit:
 - connect VCC sensor (DHT22) pin to 3.3V on ESP32
 - connect GND sensor (DHT22) pin to ESP32 GND pin
 - connect data pin of sensor DHT22 to D5 pin on microcontroller
